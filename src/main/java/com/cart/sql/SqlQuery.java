...
public class SqlQuery {
	...
	public static final String GET_PRODUCTS_BY_ID = "SELECT productname, productid, productprice, productviewimg1, productviewimg2, productviewimg3, productcount FROM products WHERE productid = ?";
